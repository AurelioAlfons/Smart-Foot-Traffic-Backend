...
console.print("\n[bold cyan]========================================[/bold cyan]")
console.print("🌦️  [bold magenta]Assigning real weather and temperature...[/bold magenta]")
...
try:
    ...
    if not dates:
        console.print("[bold yellow]⚠️ No dates found with missing weather or temperature.[/bold yellow]")
    else:
        with Progress(
